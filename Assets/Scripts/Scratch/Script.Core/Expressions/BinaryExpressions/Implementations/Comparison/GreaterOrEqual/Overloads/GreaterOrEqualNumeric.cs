...
{
    public sealed class GreaterOrEqualNumeric : GreaterOrEqualOperator, ISelfRegistrableOverload
    {
        public GreaterOrEqualNumeric()
        {
        ...
        {
            var instance = new GreaterOrEqualNumeric();
